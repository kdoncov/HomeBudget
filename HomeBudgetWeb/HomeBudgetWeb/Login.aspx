		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
                    ...
                    <asp:RequiredFieldValidator runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtUsername" Text="*" ValidationGroup="vldLogin" ID="rvfUsername"></asp:RequiredFieldValidator>
				...
				<div class="group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtPassword" Text="*" ValidationGroup="vldLogin"></asp:RequiredFieldValidator>
				</div>
			...
			<div class="sign-up-htm">
				<div class="group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtName" ValidationGroup="vldRegister" Text="*"></asp:RequiredFieldValidator>
				</div>
				<div class="group">
					<label for="txtSurname" class="label">Surname</label>
					<asp:TextBox ID="txtSurname"  runat="server" class="input"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvSurname" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="vldRegister" ControlToValidate="txtSurname" Text="*"></asp:RequiredFieldValidator>
				</div>
				<div class="group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvUsernameRegister" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="vldRegister" ControlToValidate="txtUsernameRegister" Text="*"></asp:RequiredFieldValidator>
                    <asp:Label ID="lblUsername" runat="server" ViewStateMode="Disabled"></asp:Label>
				</div>
				<div class="group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvPasswordRegister" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="vldRegister" ControlToValidate="txtPasswordRegister">*</asp:RequiredFieldValidator>
				</div>
				<div class="group">
